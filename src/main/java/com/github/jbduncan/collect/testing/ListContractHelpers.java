    ...
    if (features.contains(ListFeature.SUPPORTS_ADD_WITH_INDEX)) {
      ...
      ThrowingConsumer<CollectionSize> supportsAddAtStartWithNewElement =
          collectionSize -> {
            ...
            list.add(0, e3);
            List<E> expected = prepend(e3, newCollectionOfSize(collectionSize, samples));
      ...
      ThrowingConsumer<CollectionSize> supportsAddAtMiddleWithNewElement =
          collectionSize -> {
            ...
            Iterable<E> expected =
                insert(newCollectionOfSize(collectionSize, samples), middleIndex, e3);
            assertIterableEquals(
                expected,
                list,
                () ->
      ...
      ThrowingConsumer<CollectionSize> supportsAddAtStartWithExistingElement =
          collectionSize -> {
            ...
            list.add(0, e0);
            List<E> expected = prepend(e0, newCollectionOfSize(collectionSize, samples));
            assertIterableEquals(
                expected,
                list,
                () ->
      ...
      ThrowingConsumer<CollectionSize> supportsAddAtMiddleWithExistingElement =
          collectionSize -> {
            ...
            Iterable<E> expected =
                insert(newCollectionOfSize(collectionSize, samples), middleIndex, e0);
            assertIterableEquals(
                expected,
                list,
                () ->
